...
public class LogEventBase : IDisposable
{
    ...
    public static LogEventBase Parse(string logEntry)
    {
        var entry = new LogEventBase();
        ...
        entry.SourceId = Convert.ToInt64(entry._csv.GetField(1), 16);
        ...
        entry.DestinationId = Convert.ToInt64(entry._csv.GetField(5), 16);
